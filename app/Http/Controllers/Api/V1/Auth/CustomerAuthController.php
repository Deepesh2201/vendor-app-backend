...
class CustomerAuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $CustomerAddress->contact_person_number = $request->phone;
        $CustomerAddress->address = 'High Street';
        $CustomerAddress->latitude = '12.918804202266855';
        $CustomerAddress->longitude = '77.65186298277348';
        $CustomerAddress->user_id = $user->id;
        $CustomerAddress->contact_person_name = $user->f_name;
        $CustomerAddress->zone_id = '2';
