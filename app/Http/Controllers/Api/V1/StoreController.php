...
class StoreController extends Controller
{
    public function get_stores(Request $request, $filter_data="all")
    {
        ...
        $area_id= $request->header('areaId');
        $stores = StoreLogic::get_stores($filter_data, $type, $store_type, $request['limit'], $request['offset'], $request->query('featured'),$area_id);
    ...
    public function get_latest_stores(Request $request, $filter_data="all")
    {
        ...
        $longitude= $request->header('longitude');
        $latitude= $request->header('latitude');
        $stores = StoreLogic::get_latest_stores($request['limit'], $request['offset'], $type);
    ...
    public function get_popular_stores(Request $request)
    {
        ...
        // $longitude= $request->header('longitude');
        // $latitude= $request->header('latitude');
        $stores = StoreLogic::get_popular_stores($request['limit'], $request['offset'], $type);
    ...
    public function getstorereviewsbystore($id){
        $reviews = store_reviews::select('store_reviews.id','store_reviews.store_id','store_reviews.ratings as rating','store_reviews.reviews as comment','users.f_name as customer_name','users.image as profilepic')
