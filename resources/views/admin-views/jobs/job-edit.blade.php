...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- End Page Header -->
        <form method="post" action="{{ url('admin/jobs/update') }}/{{ $post->id }}" class="js-validate" enctype="multipart/form-data" id="vendor_form">
            @csrf
            <div class="row g-2">
                <div class="col-lg-6">
                            ...
                            <div class="lang_form" id="default-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name" id=""
                                        value="{{ $post->company_name ?? '' }}" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="job_title" id="" class="form-control"
                                        placeholder=" Job Tilte" value="{{ $post->job_title ?? '' }}">
                                </div>

                                <div class="form-group mb-0">
                                    <label class="input-label"
                                        for="exampleFormControlInput1">{{ translate('messages.Description') }}</label>
                                    <textarea type="text" name="job_description" placeholder="{{ translate('messages.Description') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <input type="radio" name="job_type" id="" class=""
                                                value="1" {{ $post->job_type == 1 ? 'checked' : '' }}><span
                                                class="ml-2">Full time</span>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-6">
                                            <input type="radio" name="job_type" id="" class=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-4">
                                            <input type="radio" name="shift" id="" class=""
                                                value="1" @if (in_array(1, $shiftId)) checked @endif><span
                                                class="ml-2">Day Shift</span>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-4">
                                            <input type="radio" name="shift" id="" class=""
                                                placeholder="dd/mm/yyyy" value="2"
                                                @if (in_array(2, $shiftId)) checked @endif><span class="ml-2">Night
                                                Shift</span>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-4">
                                            <input type="radio" name="shift" id="" class=""
                                                value="3" @if (in_array(3, $shiftId)) checked @endif><span
                                                class="ml-2">Rotational shift</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12 col-lg-12">
                                        <label class="__custom-upload-img mr-lg-5">
                                            ...
                                            <input type="file" name="logo" id="imageUpload1"
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="f_name">{{ translate('messages.Full_Name') }}</label>
