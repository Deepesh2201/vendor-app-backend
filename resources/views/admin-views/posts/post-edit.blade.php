...
<div class="content container-fluid">
    ...
    <!-- End Page Header -->
    <form method="post" action="{{url('admin/posts/update')}}/{{$post->id}}" class="js-validate"
                    ...
                    <div class="card-body">
                        ...
                        <div class="lang_form" id="default-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="" class="form-control" placeholder="Tilte"
                                    value="{{$post->title ??''}}">
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-6 col-md-6 col-md-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="floors" id="" class="form-control" placeholder="Floor"
                                            value="{{$post->floors ?? ''}}">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12 col-lg-12 uploadarea">
                                    <label class="__custom-upload-img">
                                        ...
                                        <label class="form-label">
                                            Image 1<span class="text--primary">({{ translate('2:1') }})</span>
                                        </label>
                                    ...
                                    <i class="ti ti-trash" data-image-id="{{ $post->id }}"
                                        data-image-column="image1"></i>
                                </div>
                                <div class="col-md-12 col-12 col-lg-12 uploadarea">
                                    <label class="__custom-upload-img">

                                        <label class="form-label">
                                            Image 2<span class="text--primary">({{ translate('2:1') }})</span>
                                        </label>
                                        <center>
                                            @php
                                ...
                                <div class="col-md-12 col-12 col-lg-12 uploadarea">
                                    <label class="__custom-upload-img">
                                        ...
                                        <label class="form-label">
                                            Image 3<span class="text--primary">({{ translate('2:1') }})</span>
                                        </label>
                                        <center>
                                            @php
                                    ...
                                    <i class="ti ti-trash" data-image-id="{{ $post->id }}"
                                        data-image-column="image3"></i>
                                </div>
                                <div class="col-md-12 col-12 col-lg-12 uploadarea">
                                    <label class="__custom-upload-img">

                                        <label class="form-label">
                                            Image 4<span class="text--primary">({{ translate('2:1') }})</span>
                                        </label>
                                        <center>
                                            @php
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="{{$amenity->id}}" name="amenities[]"
                            id="flexCheckChecked" @if(in_array($amenity->id,$amenityIdArray))checked @endif>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="f_name" class="form-control"
                            placeholder="{{translate('messages.first_name')}}" value="{{$post->user->f_name ?? ''}}"
                            disabled>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
